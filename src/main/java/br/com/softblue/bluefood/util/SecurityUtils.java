...
import br.com.softblue.bluefood.infraestructure.web.security.LoggedUser;
...
public class SecurityUtils {
	...
	public static Cliente loggedCliente() {
		...
		if(!(loggedUser.getUsuario() instanceof Cliente)) {
			...
			throw new IllegalStateException("O usuário não é do tipo cliente");
		}
	...
	public static Restaurante loggedRestaurante() {
		...
		if(!(loggedUser.getUsuario() instanceof Restaurante)) {
			...
			throw new IllegalStateException("O usuário não é do tipo restaurante");
		}
