...
public class InsertDataForTesting {
	...
	private Restaurante[] restaurantes() {
		...
		r.setSenha(StringUtil.encrypt("r"));
		r.setCnpj("00000000000101");
		r.setTaxaDeEntrega(BigDecimal.valueOf(3.2));
		...
		r.setTaxaDeEntrega(BigDecimal.valueOf(4.5));
		...
		r.setTaxaDeEntrega(BigDecimal.valueOf(12.2));
		...
		r.setTaxaDeEntrega(BigDecimal.valueOf(9.8));
		...
		r.setTaxaDeEntrega(BigDecimal.valueOf(14.9));
	...
	private Cliente[] clientes() {
		...
		c.setSenha(StringUtil.encrypt("c"));
		c.setCep("89300100");
